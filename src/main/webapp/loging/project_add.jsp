    ...
    <div class="x-body">
        <form class="layui-form">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="username" name="username" style="width: 58px;display: inline;" required lay-verify="required" autocomplete="off" value="admin" class="layui-input">&nbsp;&nbsp;&nbsp;&nbsp;--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="text" id="username" name="username" style="width: 58px;display: inline;" required lay-verify="required" autocomplete="off" value="admin" class="layui-input">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="username" name="username" required lay-verify="required" autocomplete="off" value="admin" class="layui-input">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
              	<textarea name="" cols="24" rows="4"></textarea>
