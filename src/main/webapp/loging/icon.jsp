...
<script type="text/javascript">
		$(function(){
			$("li").click(function(){
				var aa=$(this).children().eq(1).text();
				var bb=$(this).children().eq(2).text();
				window.parent.document.getElementById("tb").value=aa;
				window.parent.document.getElementById("icon").value=bb;
				// 获得frame索引
